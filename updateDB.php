	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable(
			...
			CREATE TABLE IF NOT EXISTS `lideres` ( 
				...
				" ALTER TABLE `lideres` CHANGE `CEDULA` `CEDULA` INT NULL ",
				" ALTER TABLE `lideres` CHANGE `CEDULA` `CEDULA` INT(10) NULL ",
				" ALTER TABLE `lideres` CHANGE `CELULAR` `CELULAR` INT NULL ",
				" ALTER TABLE `lideres` CHANGE `CELULAR` `CELULAR` INT(10) NULL ",
			]
		);
		...
		setupTable(
			...
			CREATE TABLE IF NOT EXISTS `amigos` ( 
				...
				" ALTER TABLE `amigos` CHANGE `LIDER` `LIDER` VARCHAR(40) NULL DEFAULT '1111111111' ",
				" ALTER TABLE `amigos` CHANGE `LIDER` `LIDER` VARCHAR(10) NULL DEFAULT '1111111111' ",
				" ALTER TABLE `amigos` CHANGE `CEDULA` `CEDULA` INT NULL ",
				" ALTER TABLE `amigos` CHANGE `CEDULA` `CEDULA` INT(10) NULL ",
				" ALTER TABLE `amigos` CHANGE `CELULAR` `CELULAR` INT NULL ",
				" ALTER TABLE `amigos` CHANGE `CELULAR` `CELULAR` INT(10) NULL ",
			]
		);
