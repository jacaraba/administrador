	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable(
			...
			CREATE TABLE IF NOT EXISTS `amigos` ( 
				...
				" ALTER TABLE `amigos` CHANGE `ESTADO` `ESTADO` VARCHAR(10) NOT NULL DEFAULT 'INGRESADO' ",
				" ALTER TABLE `amigos` CHANGE `LIDER` `LIDER` VARCHAR(10) NOT NULL DEFAULT '1111111111' ",
			]
		);
